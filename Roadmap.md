...
**Resources to learn more:**
- [Video: Introduction to AWS EC2](https://docs.aws.amazon.com/ec2/)
...
**Resources to learn more:**
- [CI/CD Explained](https://docs.aws.amazon.com/whitepapers/latest/cicd_for_5g_networks_on_aws/cicd-on-aws.html)
...
- [Infrastructure as Code (IaC) Serverless](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/what-is-iac.html)
